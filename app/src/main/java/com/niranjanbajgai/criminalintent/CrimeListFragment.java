...
/**
 * Created by niranjanbajgai on 14-10-22.
 */
public class CrimeListFragment extends ListFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.list_item_empty,container,false);
        ListView view = (ListView) v.findViewById(android.R.id.list);
        view.setEmptyView(v.findViewById(android.R.id.empty));
        addCrimeButton = (Button)v.findViewById(R.id.add_new_crime_to_empty_list);
